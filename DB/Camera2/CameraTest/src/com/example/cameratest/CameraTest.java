...
import com.example.cameratest.ShutterButton;
...
public class CameraTest extends Activity implements ShutterButton.OnShutterButtonListener {
...
*/
		// 오토 포커스 시작
		findViewById(R.id.btn_flash).setOnClickListener(
		...
		// 사진 촬영
		mShutter = (Button) findViewById(R.id.shutter_button);
