...
public class SearchMain extends Activity implements OnItemClickListener,
	...
	class IncomingHandelerCallback implements Handler.Callback {
		...
		public boolean handleMessage(Message msg) {
			...
			adapter = new CustomAdapter(SearchMain.this,
		...
		new AlertDialog.Builder(this)/*.setTitle(title)*/.setMessage(message + " 등록하시겠습니까?")
				.setPositiveButton("확인", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						Intent intent = new Intent(SearchMain.this, MainActivity.class);
